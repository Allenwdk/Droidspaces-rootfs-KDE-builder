...
- **anland_kde 支持**（目前仅 Ubuntu 26）：为 Wayland 提供特殊支持，通过 patched KWin 和 Xwayland 实现与 anland 显示后端的直接通信。需要同时启用 KDE 桌面，详细配置参考下文"📱 anland_kde配置方法"。项目上游：[anland](https://github.com/superturtlee/anland)
